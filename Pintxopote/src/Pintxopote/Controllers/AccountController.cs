        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Alta usuario
                    Erabiltzailea eerabiltzailea = new Erabiltzailea();
                    eerabiltzailea.Id = (db.Erabiltzailea.ToList().Count()+1).ToString();
                    eerabiltzailea.Email = model.Email;
                    eerabiltzailea.Pasahitza = model.Password;
                    if (ModelState.IsValid)
                    {
                        db.Erabiltzailea.Add(eerabiltzailea);
                        db.SaveChanges();
                    }
